...
/**
 * Fabric 原生配置界面
 * <p>提供分页的图形化配置界面，不依赖 cloth-config。</p>
 *
...
public class FabricConfigScreen extends Screen {
    ...
    protected void init() {
        ...
        switch (currentPage) {
            case 0 -> initPageGeneral(centerX, startY, buttonWidth, buttonHeight, spacing);
            case 1 -> initPageConsumption(centerX, startY, buttonWidth, buttonHeight, spacing);
            case 2 -> initPageAdvanced(centerX, startY, buttonWidth, buttonHeight, spacing);
        }
