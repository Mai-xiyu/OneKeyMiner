...
/**
 * Fabric 原生配置界面
 * <p>使用 Minecraft 原版 Screen API 实现的分页配置界面，
...
public class FabricConfigScreen extends Screen {
    ...
    private void addBoolButton(int x, int y, int w, int h, String key,
    ...
    private void addCycleButton(int x, int y, int w, int h, String key,
                                Supplier<Integer> getter, Consumer<Integer> setter, int[] presets) {
        this.addRenderableWidget(Button.builder(
