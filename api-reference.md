...
- `onekeyminer-fabric-1.6.8-1.21.1.jar`
- `onekeyminer-forge-1.6.8-1.21.1.jar`
- `onekeyminer-neoforge-1.6.8-1.21.1.jar`
...
```groovy
dependencies {
    modCompileOnly files("libs/onekeyminer-fabric-1.6.8-1.21.1.jar")
}
```
...
```groovy
dependencies {
    compileOnly fg.deobf(files("libs/onekeyminer-forge-1.6.8-1.21.1.jar"))
}
```
...
```groovy
dependencies {
    compileOnly files("libs/onekeyminer-neoforge-1.6.8-1.21.1.jar")
}
```
