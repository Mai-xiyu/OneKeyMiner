# OneKeyMiner 1.21.5 API Reference
...
- `onekeyminer-fabric-1.6.7-1.21.5.jar`
- `onekeyminer-forge-1.6.7-1.21.5.jar`
- `onekeyminer-neoforge-1.6.7-1.21.5.jar`
...
- API examples in this document target only Minecraft 1.21.5 / OneKeyMiner
