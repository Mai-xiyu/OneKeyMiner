...
final class ForgeNetworkingCodecTest {
    private static final int SEQUENCE = 23;
    ...
    void requestCodecUsesCanonicalFieldOrder() {
        ...
        try {
            ...
            assertEquals(expected, ForgeNetworking.ClientPreferencesPacket.fromNetwork(canonical));
    ...
    private static void writeRequestFields(FriendlyByteBuf buffer) {
        ...
        buffer.writeUtf(SHAPE, ForgeNetworking.MAX_SHAPE_ID_LENGTH);
        buffer.writeBoolean(true);
    ...
    private static void assertRequestFields(FriendlyByteBuf buffer) {
        ...
        assertEquals(SHAPE, buffer.readUtf(ForgeNetworking.MAX_SHAPE_ID_LENGTH));
        assertEquals(true, buffer.readBoolean());
