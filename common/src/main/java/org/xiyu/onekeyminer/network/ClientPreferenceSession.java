...
/**
 * Non-persistent client view of the latest server-authoritative preference
 * acknowledgement. Dedicated servers may load this class, but never populate it.
 */
public final class ClientPreferenceSession {
    ...
    public static PreviewPolicy resolvePreviewPolicy(MinerConfig localConfig) {
        ...
        if (ack == null || !ack.supports(ClientPreferenceProtocol.CAP_SERVER_PREVIEW_POLICY)) {
