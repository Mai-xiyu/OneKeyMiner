...
public final class OneKeyMinerAPI {
    ...
    /**
     * Returns the latest server-authoritative preference snapshot acknowledged
     * for this physical client connection.
     *
     * @return acknowledgement, or empty before negotiation/disconnect
     */
