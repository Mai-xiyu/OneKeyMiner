...
public class ChainPreviewHud {
    ...
    public static void render(GuiGraphicsExtractor guiGraphics) {
        ...
        int y = HUD_Y;
        guiGraphics.text(font, titleLine, HUD_X, y, TITLE_COLOR);
        y += LINE_SPACING;
        guiGraphics.text(font, shapeLine, HUD_X, y, TEXT_COLOR);
        y += LINE_SPACING;
        guiGraphics.text(font, countLine, HUD_X, y, COUNT_COLOR);
        y += LINE_SPACING;
        guiGraphics.text(font, maxLine, HUD_X, y, TEXT_COLOR);
    }
}
