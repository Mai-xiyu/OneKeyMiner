...
- `onekeyminer-fabric-1.6.7-1.21.11.jar` for Fabric
- `onekeyminer-neoforge-1.6.7-1.21.11.jar` for NeoForge
- `onekeyminer-forge-1.6.7-1.21.11.jar` for Forge
...
- **Tag format**: `<branch>-<mod_version>` (example: `1.21.11-1.6.7`).
